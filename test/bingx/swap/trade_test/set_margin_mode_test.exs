defmodule BingX.Swap.TradeTest.SetMarginModeTest do
  @moduledoc """
  ...
  setup_all do
    {
      :ok,
      api_key: "API_KEY_FOR_TEST", secret_key: "SECRET_KEY_FOR_TEST", path: "/openApi/swap/v2/trade/marginType"
    }
  end

  describe "BingX.Swap.Trade set_margin_mode/4" do
    test "should make POST request", context do
      ...
      Trade.set_margin_mode("BTC-USDT", :crossed, api_key, secret_key)
    ...
    test "should put the symbol and correct margin_mode into query params", context do
      %{api_key: api_key, secret_key: secret_key} = context
    ...
    test "should return the original request http-error", context do
      ...
      assert ^error = Trade.set_margin_mode("BTC-USDT", :crossed, api_key, secret_key)
    end
    ...
    test "should return an :ok atom on success", context do
      %{api_key: api_key, secret_key: secret_key} = context
      ...
      assert :ok = Trade.set_margin_mode("BTC-USDT", :crossed, api_key, secret_key)
