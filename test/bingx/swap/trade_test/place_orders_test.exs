defmodule BingX.Swap.TradeTest.PlaceOrdersTest do
  @moduledoc """
  ...
  setup_all do
    ...
    {
      :ok,
      orders: orders, api_key: "API_KEY_FOR_TEST", secret_key: "SECRET_KEY_FOR_TEST", path: "/openApi/swap/v2/trade/batchOrders"
    }
  end
