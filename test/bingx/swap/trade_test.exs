defmodule BingX.Swap.TradeTest do
  @moduledoc """
  ...
  alias BingX.Swap.Trade.{PlaceOrderResponse, CancelAllOrdersResponse, CancelOrderResponse}
  alias BingX.Swap.Order
  alias BingX.Swap.Order.TriggerMarket
